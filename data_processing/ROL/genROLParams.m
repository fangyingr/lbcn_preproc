function ROLparams = genROLParams(project_name)
...
ROLparams.mindur = 0.1;    % signal must exceed threshold for at least this duration (s)
...
if strcmp(project_name,'Memoria')  
   ROLparams.bl = [-0.5 0]; 
   ROLparams.pre_event = -0.5;
   ROLparams.mindur = 0.1;
   ROLparams.dur = 7;
end
