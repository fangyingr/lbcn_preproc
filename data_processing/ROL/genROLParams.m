...
ROLparams.noise_fields_trials= {'bad_epochs_HFO','bad_epochs_raw_LFspike','bad_epochs_raw_HFspike'}; % can combine any of the bad_epoch fields in data.trialinfo (will take union of selected fields)
ROLparams.noise_fields_timepts= {'bad_inds_HFO','bad_epochs_raw_LFspike','bad_inds_raw_HFspike'}; % can combine any of the bad_epoch fields in data.trialinfo (will take union of selected fields)
ROLparams.firststim=true;  % for memoria only calculate rol after the first stim (true), calculate rol for all stim (false)
